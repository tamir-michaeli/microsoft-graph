...
//        HttpURLConnection con = Office365HttpRequests.createHttpConnection("http://localhost:8080/");
...
//        HttpURLConnection con = Office365HttpRequests.createHttpConnection(url);
//        Office365HttpRequests.getAccessToken(con, "0000", "0000");
//
